...
interface IPMDWIN : public IFMPMD {
	...
	virtual char* WINAPI getmemo(char *dest, const uint8_t *musdata, int size, int al) = 0;
	virtual char* WINAPI getmemo2(char *dest, const uint8_t *musdata, int size, int al) = 0;
	virtual char* WINAPI getmemo3(char *dest, const uint8_t *musdata, int size, int al) = 0;
	virtual int	WINAPI fgetmemo(char *dest, const TCHAR *filename, int al) = 0;
	virtual int	WINAPI fgetmemo2(char *dest, const TCHAR *filename, int al) = 0;
	virtual int	WINAPI fgetmemo3(char *dest, const TCHAR *filename, int al) = 0;
	...
	virtual int WINAPI ppc_load(const TCHAR *filename) = 0;
	virtual int WINAPI pps_load(const TCHAR *filename) = 0;
	virtual int WINAPI p86_load(const TCHAR *filename) = 0;
	virtual int WINAPI ppz_load(const TCHAR *filename, int bufnum) = 0;
