...
//=============================================================================
int PMDWIN::music_load3(const uint8_t *musdata, int size, const TCHAR *current_dir)
{
...
//	ppc_load（内部処理）
//=============================================================================
int PMDWIN::ppc_load2(const TCHAR *filename)
{
	uint8_t	*pcmbuf;
	int		size, result;
...
//	 ppc_load その３（メモリから）
//=============================================================================
int PMDWIN::ppc_load3(const uint8_t *pcmdata, int size)
{
	int			i;
...
//	初期化
//=============================================================================
bool WINAPI PMDWIN::init(const TCHAR *path)
{
	int		i;
...
//	リズム音の再読み込み
//=============================================================================
bool WINAPI PMDWIN::loadrhythmsample(const TCHAR *path)
{
	TCHAR	path2[_MAX_PATH];
...
//	PCM 検索ディレクトリの設定
//=============================================================================
bool WINAPI PMDWIN::setpcmdir(const TCHAR **path)
{
	int		i = 0;
...
//	曲の読み込みその１（ファイルから）
//=============================================================================
int WINAPI PMDWIN::music_load(const TCHAR *filename)
{
	int		size, result;
...
//	曲の読み込みその２（メモリから）
//=============================================================================
int WINAPI PMDWIN::music_load2(const uint8_t *musdata, int size)
{
...
//	メモの取得（内部動作）
//=============================================================================
char* WINAPI PMDWIN::_getmemo(char *dest, const uint8_t *musdata, int size, int al)
{
	const uint8_t	*si, *mmlbuf;
	int		i, dx;
	int		maxsize;
...
//=============================================================================
char* WINAPI PMDWIN::_getmemo2(char *dest, const uint8_t *musdata, int size, int al)
{
	char	*buf;
	char	*rslt;
...
//=============================================================================
char* WINAPI PMDWIN::_getmemo3(char *dest, const uint8_t *musdata, int size, int al)
{
	char	*buf;
	char	*rslt;
...
//	メモの取得（内部動作、ファイル名から）
//=============================================================================
int WINAPI PMDWIN::_fgetmemo(char *dest, const TCHAR *filename, int al)
{
	uint8_t	*mmlbuf;
	int		size;
...
//=============================================================================
int WINAPI PMDWIN::_fgetmemo2(char *dest, const TCHAR *filename, int al)
{
	char	*buf;
	int		rslt;
...
//=============================================================================
int WINAPI PMDWIN::_fgetmemo3(char *dest, const TCHAR *filename, int al)
{
	char	*buf;
	int		rslt;
...
//	メモの取得
//=============================================================================
char* WINAPI PMDWIN::getmemo(char *dest, const uint8_t *musdata, int size, int al)
{
	char	*buf;
...
//=============================================================================
char* WINAPI PMDWIN::getmemo2(char *dest, const uint8_t *musdata, int size, int al)
{
	char	*buf;
...
//=============================================================================
char* WINAPI PMDWIN::getmemo3(char *dest, const uint8_t *musdata, int size, int al)
{
	char	*buf;
...
//	メモの取得（ファイル名から）
//=============================================================================
int	WINAPI PMDWIN::fgetmemo(char *dest, const TCHAR *filename, int al)
{
	char	*buf;
	int		rslt;
...
//=============================================================================
int	WINAPI PMDWIN::fgetmemo2(char *dest, const TCHAR *filename, int al)
{
	char	*buf;
	int		rslt;
...
//	メモの取得（ファイル名から／半角文字に変換＋ESCシーケンスの除去）
//=============================================================================
int	WINAPI PMDWIN::fgetmemo3(char *dest, const TCHAR *filename, int al)
{
	char	*buf;
	int		rslt;
...
//	.PPC の読み込み（ファイルから）
//=============================================================================
int WINAPI PMDWIN::ppc_load(const TCHAR *filename)
{
	int		resultppc;
...
//	.PPS の読み込み（ファイルから）
//=============================================================================
int WINAPI PMDWIN::pps_load(const TCHAR *filename)
{
	int		result;
...
//	.P86 の読み込み（ファイルから）
//=============================================================================
int WINAPI PMDWIN::p86_load(const TCHAR *filename)
{
	int		result;
...
//=============================================================================
int WINAPI PMDWIN::ppz_load(const TCHAR *filename, int bufnum)
{
	int		result;
...
//	曲の長さの取得(pos : ms)
//=============================================================================
bool WINAPI PMDWIN::getlength(const TCHAR *filename, int *length, int *loop)
{
	int		us;
	int		result;
	int		fmwaittemp;
...
//=============================================================================
bool WINAPI PMDWIN::getlength2(const TCHAR *filename, int *length, int *loop)
{
	int		us;
	int		result;
	int		fmwaittemp;
